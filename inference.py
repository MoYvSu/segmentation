...
def predict_single_image(
    ...
    if output_dir is not None:
        output_paths, inst_map, class_map = post_process_prediction_boundary(
            ...
            sem_edge_valley_weight=sem_edge_valley_weight,
            sem_edge_gradient_weight=sem_edge_gradient_weight,
            semantic_primary=semantic_primary,
            sem_band_width=sem_band_width,
            sem_line_weight=sem_line_weight,
...
def main():
    ...
    for img_path in image_paths:
        ...
        result = predict_single_image(
            ...
            sem_edge_valley_weight=infer_cfg.get("sem_edge_valley_weight", 1.0),
            sem_edge_gradient_weight=infer_cfg.get("sem_edge_gradient_weight", 1.0),
            semantic_primary=infer_cfg.get("semantic_primary", False),
            sem_band_width=infer_cfg.get("sem_band_width", 2),
            sem_line_weight=infer_cfg.get("sem_line_weight", 3.0),
            sem_percentile=infer_cfg.get("sem_percentile", 80.0),
