...
def predict_single_image(
    ...
    sem_edge_smooth=1.0,
    use_tta=False,
    watershed_method="skeleton",
    marker_smooth_sigma=1.5,
    marker_h_ratio=0.3,
    bridge_width=1,
    ...
    if output_dir is not None:
        output_paths, inst_map, class_map = post_process_prediction_boundary(
            ...
            marker_smooth_sigma=marker_smooth_sigma,
            marker_h_ratio=marker_h_ratio,
...
def main():
    ...
    for img_path in image_paths:
        ...
        result = predict_single_image(
            ...
            watershed_method=infer_cfg.get("watershed_method", "skeleton"),
            marker_smooth_sigma=infer_cfg.get("marker_smooth_sigma", 1.5),
            marker_h_ratio=infer_cfg.get("marker_h_ratio", 0.3),
