...
E9 epoch 20 probability-mean 继续保留为历史回退；E10a 已通过固定部署口径和黑盒提交晋级。
...
| 方案 | mIoU | 铁素体面积项 | 总分 |
|---|---:|---:|---:|
| V6 + G4b watershed | 0.8441 | 0.7693 | 80.67 |
| E9 + G4b watershed | 0.8421 | 0.7917 | 81.69 |
| E10a-only + G4b watershed | 0.8381 | 0.8408 | 83.94 |

E10a 以 `-0.0040` mIoU 换得相对 E9 `+0.0491` 的面积项，净增约 `2.25` 分，现为当前
黑盒最佳单模型语义头。后续语义实验应从 E10a 初始化并守住面积项，不再默认回到 E9/V6。
