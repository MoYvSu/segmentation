...
[D2低噪声对照](RGB_DIFFUSION_D2_K003_20260923.md)已发起：仅kappa从0.1降至0.03，
先执行原60轮日程的前20轮/5000更新，自动保存首步与16步过程图，不自动续训。
112张过程图完整保留。用户回报v6复赛0.8448/0.8506，低于v4的0.8465/0.8678，v4继续作为有分数的修复参照。
