...
后续已完成正式60轮／3840更新、全量推理打包及分析；详见
[训练结果与亮度诊断](SEMANTIC_D5A_ANALYSIS_20260925.md)。后续用户回报full
`0.8473/0.8461`（84.670）、simple `0.8471/0.8437`（84.540），差0.130分；
两组均未超过原D5a或原图baseline，面积项退步，保留简化结构研究但不晋级权重。
