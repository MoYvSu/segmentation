...
> 当前开展“冻结主线 + 双头信息交流”的小型修正对照；直接实例掩码路线停止继续投入。实验关系与入口见
...
- **当前双头实验**：固定 E10a+G4b，比较等参数的自身信息修正与跨头信息修正；仅训练87,113个
  新参数，原模型、融合、分水岭固定。先验证最终输出的零修正兼容，再各训练20轮，以五图
  验证损失选优。见[实现与运行](docs/MAINLINE_CROSS_HEAD_EXPERIMENT_20260911.md)。
