...
> 扩散专用工作区：`codex/diffusion-restoration-20260923`。[D1全量60轮分析](docs/RGB_DIFFUSION_ALL60_ANALYSIS_20260923.md)：1000图/15000更新完整完成、零失败，后期趋于平台；16步的梯度误差高于输入且真实图颗粒增加，暂不晋级。首步的训练配对误差较低，尚无D1黑盒分数。v6本轮用户回分0.8448/0.8506、总分84.770，低于v4的85.715；保留v4作为已验证修复基准，下一项建议降低扩散噪声，尚未新训。
