...
> 扩散专用工作区：`codex/diffusion-restoration-20260923`。[D3起点强化20轮分析](docs/RGB_DIFFUSION_D3_ANALYSIS_20260923.md)：5000更新零失败、48张过程图完整。噪声仍为0.03，起点抽样50.13%；首步恢复明显，固定训练配对RGB/梯度误差比为0.607/0.904，完整16步为0.782/1.140，多步退化仍在。建议原配方续到60轮，尚未执行或获得D3黑盒成绩。[D2](docs/RGB_DIFFUSION_D2_ANALYSIS_20260923.md)的近恒等输出得到改善，[D1](docs/RGB_DIFFUSION_ALL60_ANALYSIS_20260923.md)完整采样暂不晋级。v6复赛0.8448/0.8506、总分84.770，低于v4的85.715，v4继续作为已验证修复基准。下游适应问题保留为独立假设。
